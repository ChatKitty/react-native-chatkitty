...
exports.default = exports.ChatKitty = void 0;
...
var _callSignal = require("./call-signal");

var _stompx = _interopRequireDefault(require("./stompx"));
...
var _userMediaSettings = require("./user-media-settings");
...
class ChatKitty {
  ...
  constructor(configuration) {
    ...
    _defineProperty(this, "currentUserSubject", new _rxjs.BehaviorSubject(null));

    _defineProperty(this, "lostConnectionSubject", new _rxjs.Subject());

    _defineProperty(this, "resumedConnectionSubject", new _rxjs.Subject());
    ...
    _defineProperty(this, "keyStrokesSubject", new _rxjs.Subject());
    ...
    _defineProperty(this, "Calls", new class ChatKittyCalls {
      ...
      constructor(kitty) {
        ...
        _defineProperty(this, "participantAcceptedCallSubject", new _rxjs.Subject());

        _defineProperty(this, "participantDeclinedCallSubject", new _rxjs.Subject());

        _defineProperty(this, "participantActiveSubject", new _rxjs.Subject());

        _defineProperty(this, "participantLeftCallSubject", new _rxjs.Subject());

        _defineProperty(this, "participantMediaSettingsUpdatedSubject", new _rxjs.Subject());

        _defineProperty(this, "callEndedSubject", new _rxjs.Subject());
      ...
      async initialize(configuration) {
        ...
        this.configuration = configuration;
        this.localStream = await _reactNativeWebrtc.mediaDevices.getUserMedia(constraints);
      ...
      startCall(request) {
        return new Promise(async resolve => {
          ...
          if (!channel) {
            ...
            if ((0, _result.succeeded)(result)) {
              channel = result.channel;
            }

            if ((0, _result.failed)(result)) {
              resolve(result);
            }
          }
          ...
          this.kitty.stompX.sendAction({
            ...
            onSuccess: call => {
              this.startCallSession(call).then(() => resolve(new _call.StartedCallResult(call)));
            },
            onError: error => {
              resolve(new _result.ChatKittyFailedResult(error));
            }
          });
        });
      }
      ...
      acceptCall(request) {
        return new Promise(resolve => {
          this.startCallSession(request.call).then(() => {
            resolve(new _call.AcceptedCallResult(request.call));
          });
        });
      }
      ...
      declineCall(request) {
        return new Promise(resolve => {
          this.kitty.stompX.sendAction({
            ...
            body: {},
            onSuccess: call => {
              resolve(new _call.DeclinedCallResult(call));
            },
            onError: error => {
              resolve(new _result.ChatKittyFailedResult(error));
            }
      ...
      getCalls(request) {
        ...
        return new Promise(resolve => {
          _pagination.ChatKittyPaginator.createInstance({
            stompX: this.kitty.stompX,
            relay: request.channel._relays.calls,
            contentName: 'calls',
            parameters: parameters
          }).then(paginator => resolve(new _call.GetCallsSucceededResult(paginator))).catch(error => resolve(new _result.ChatKittyFailedResult(error)));
        });
      }
      ...
      getCall(id) {
        return new Promise(resolve => {
          this.kitty.stompX.relayResource({
            ...
            onSuccess: call => {
              resolve(new _call.GetCallSucceededResult(call));
            },
            onError: error => {
              resolve(new _result.ChatKittyFailedResult(error));
            }
      ...
      getCurrentCallParticipants() {
        ...
        if (!currentCall) {
          throw new _call.NoActiveCallError();
        }
        ...
        return new Promise(resolve => {
          _pagination.ChatKittyPaginator.createInstance({
            ...
            contentName: 'users'
          }).then(paginator => resolve(new _user.GetUsersSucceededResult(paginator))).catch(error => resolve(new _result.ChatKittyFailedResult(error)));
        });
      }
      ...
      getUserMediaSettings(request) {
        return new Promise(resolve => {
          this.kitty.stompX.relayResource({
            ...
            onSuccess: settings => {
              resolve(new _userMediaSettings.GetUserMediaSettingsSucceededResult(settings));
            },
            onError: error => {
              resolve(new _result.ChatKittyFailedResult(error));
            }
      ...
      onCallInvite(onNextOrObserver) {
        ...
        if (!user) {
          throw new _userSession.NoActiveSessionError();
        }
      ...
      startCallSession(call) {
        return new Promise(resolve => {
          ...
          const signalSubject = new _rxjs.Subject();
          ...
          const signalsSubscription = signalSubject.subscribe({
            next: async signal => {
              try {
                if ((0, _callSignal.isCreateOfferCallSignal)(signal)) {
                  await onCreateOffer(signal);
                }

                if ((0, _callSignal.isAnswerOfferCallSignal)(signal)) {
                  await onAnswerOffer(signal);
                }

                if ((0, _callSignal.isAddCandidateCallSignal)(signal)) {
                  const connection = connections.get(signal.peer.id);
                ...
                if ((0, _callSignal.isSendDescriptionCallSignal)(signal)) {
                  const connection = connections.get(signal.peer.id);
                ...
                if ((0, _callSignal.isDisconnectPeerCallSignal)(signal)) {
    ...
    this.stompX = new _stompx.default({
      isSecure: configuration.isSecure === undefined || configuration.isSecure,
      host: configuration.host || 'api.chatkitty.com',
      isDebug: !_environment.environment.production
    });
    this.keyStrokesSubject.asObservable().pipe((0, _operators.debounceTime)(150)).subscribe(request => {
      let destination = '';
  ...
  startSession(request) {
    if (this.stompX.initialized) {
      throw new _userSession.SessionActiveError();
    }
    ...
    return new Promise(resolve => {
      this.stompX.connect({
        ...
        onSuccess: (user, writeFileGrant, readFileGrant) => {
          ...
          resolve(new _userSession.StartedSessionResult({
            user: user
          }));
        },
        onConnected: user => {
  ...
  getCurrentUser() {
    ...
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: user => {
          resolve(new _currentUser.GetCurrentUserSuccessfulResult(user));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  updateCurrentUser(update) {
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: user => {
          this.currentUserSubject.next(user);
          resolve(new _currentUser.UpdatedCurrentUserResult(user));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
    ...
    return new Promise(resolve => {
      ...
      if (file instanceof Blob) {
        this.stompX.sendToStream({
          ...
          blob: file,
          onSuccess: user => {
            resolve(new _currentUser.UpdatedCurrentUserDisplayPictureResult(user));
          },
          onError: error => {
            resolve(new _result.ChatKittyFailedResult(error));
          },
          progressListener: {
            ...
            onCompleted: () => {
              ...
              return (_request$progressList4 = request.progressListener) === null || _request$progressList4 === void 0 ? void 0 : _request$progressList4.onCompleted(_file.ChatKittyUploadResult.COMPLETED);
            },
            onFailed: () => {
              var _request$progressList5;

              return (_request$progressList5 = request.progressListener) === null || _request$progressList5 === void 0 ? void 0 : _request$progressList5.onCompleted(_file.ChatKittyUploadResult.FAILED);
            },
            onCancelled: () => {
              var _request$progressList6;

              return (_request$progressList6 = request.progressListener) === null || _request$progressList6 === void 0 ? void 0 : _request$progressList6.onCompleted(_file.ChatKittyUploadResult.CANCELLED);
            }
          }
        });
      } else {
  ...
  updateChannel(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: channel => {
          resolve(new _channel.UpdatedChannelResult(channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  deleteChannel(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSuccess: () => {
          resolve(new _channel.DeletedChannelResult());
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  createChannel(request) {
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: request,
        onSuccess: channel => {
          resolve(new _channel.CreatedChannelResult(channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  getChannels(request) {
    ...
    return new Promise(resolve => {
      ...
      _pagination.ChatKittyPaginator.createInstance({
        ...
        parameters: parameters
      }).then(paginator => resolve(new _channel.GetChannelsSucceededResult(paginator))).catch(error => resolve(new _result.ChatKittyFailedResult(error)));
    });
  }
  ...
  getChannel(id) {
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: channel => {
          resolve(new _channel.GetChannelSucceededResult(channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  joinChannel(request) {
    ...
    if (!destination) {
      throw new _channel.ChannelNotPubliclyJoinableError(request.channel);
    }
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: request,
        onSuccess: channel => {
          resolve(new _channel.JoinedChannelResult(channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  leaveChannel(request) {
    ...
    if (!destination) {
      throw new _channel.NotAChannelMemberError(request.channel);
    }
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSuccess: channel => {
          resolve(new _channel.LeftChannelResult(channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  addChannelModerator(request) {
    ...
    if (!destination) {
      throw new _channel.CannotAddModeratorToChannelError(request.channel);
    }
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: request.user,
        onSuccess: channel => {
          resolve(new _channel.AddedChannelModeratorResult(channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  getUnreadChannelsCount(request) {
    ...
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        parameters: parameters,
        onSuccess: resource => {
          resolve(new _result.GetCountSucceedResult(resource.count));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  getChannelUnread(request) {
    ...
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: resource => {
          resolve(new _channel.GetChannelUnreadSucceededResult(resource.exists));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  readChannel(request) {
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSent: () => resolve(new _channel.ReadChannelSucceededResult(request.channel)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  muteChannel(request) {
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: channel => {
          resolve(new _channel.MutedChannelResult(channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  unmuteChannel(request) {
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: channel => {
          resolve(new _channel.UnmutedChannelResult(channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  clearChannelHistory(request) {
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSuccess: channel => resolve(new _channel.ClearChannelHistorySucceededResult(channel)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  hideChannel(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSuccess: resource => resolve(new _channel.HideChannelSucceededResult(resource)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  startChatSession(request) {
    ...
    return new _chatSession.StartedChatSessionResult(session);
  }
    ...
    return new Promise(resolve => {
      ...
      if (isSendChannelTextMessageRequest(request)) {
        this.stompX.sendAction({
          ...
          onSuccess: message => {
            resolve(new _message.SentTextMessageResult(this.messageMapper.map(message)));
          },
          onError: error => {
            resolve(new _result.ChatKittyFailedResult(error));
          }
      ...
      if (isSendChannelFileMessageRequest(request)) {
        ...
        if (isCreateChatKittyExternalFileProperties(file)) {
          this.stompX.sendAction({
            ...
            onSuccess: message => {
              resolve(new _message.SentFileMessageResult(this.messageMapper.map(message)));
            },
            onError: error => {
              resolve(new _result.ChatKittyFailedResult(error));
            }
          ...
          this.stompX.sendToStream({
            ...
            progressListener: {
              ...
              onCompleted: () => {
                ...
                return (_request$progressList10 = request.progressListener) === null || _request$progressList10 === void 0 ? void 0 : _request$progressList10.onCompleted(_file.ChatKittyUploadResult.COMPLETED);
              },
              onFailed: () => {
                var _request$progressList11;

                return (_request$progressList11 = request.progressListener) === null || _request$progressList11 === void 0 ? void 0 : _request$progressList11.onCompleted(_file.ChatKittyUploadResult.FAILED);
              },
              onCancelled: () => {
                var _request$progressList12;

                return (_request$progressList12 = request.progressListener) === null || _request$progressList12 === void 0 ? void 0 : _request$progressList12.onCompleted(_file.ChatKittyUploadResult.CANCELLED);
              }
            }
          });
        }
  ...
  getMessages(request) {
    ...
    return new Promise(resolve => {
      ...
      }).then(paginator => resolve(new _message.GetMessagesSucceededResult(paginator))).catch(error => resolve(new _result.ChatKittyFailedResult(error)));
    });
  }
  ...
  triggerEvent(request) {
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSent: () => {
          resolve(new _event.TriggeredEventResult(request.channel));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  readMessage(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSent: () => resolve(new _message.ReadMessageSucceededResult(request.message)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  getLastReadMessage(request) {
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: resource => {
          resolve(new _message.GetLastReadMessageResult(resource));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  editMessage(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: message => resolve(new _message.EditedMessageSucceededResult(message)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  getMessageChannel(request) {
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: resource => {
          resolve(new _message.GetMessageChannelSucceededResult(resource));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  getMessageParent(request) {
    return new Promise(resolve => {
      ...
      if (!destination) {
        throw new _message.MessageNotAReplyError(request.message);
      }

      this.stompX.relayResource({
        destination,
        onSuccess: resource => {
          resolve(new _message.GetMessageParentSucceededResult(resource));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  createThread(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: thread => resolve(new _thread.CreatedThreadResult(thread)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  getThreads(request) {
    ...
    return new Promise(resolve => {
      _pagination.ChatKittyPaginator.createInstance({
        ...
        contentName: 'threads',
        parameters
      }).then(paginator => resolve(new _thread.GetThreadsSucceededResult(paginator))).catch(error => resolve(new _result.ChatKittyFailedResult(error)));
    });
  }
  ...
  getThreadChannel(request) {
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: resource => {
          resolve(new _thread.GetThreadChannelSucceededResult(resource));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  getThreadMessage(request) {
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: resource => {
          resolve(new _thread.GetThreadMessageSucceededResult(resource));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  readThread(request) {
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSent: () => resolve(new _thread.ReadThreadSucceededResult(request.thread)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  reactToMessage(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: reaction => resolve(new _reaction.ReactedToMessageResult(reaction)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  getReactions(request) {
    return new Promise(resolve => {
      ...
      }).then(paginator => resolve(new _reaction.GetReactionsSucceededResult(paginator))).catch(error => resolve(new _result.ChatKittyFailedResult(error)));
    });
  }
  ...
  removeReaction(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: reaction => resolve(new _reaction.RemovedReactionResult(reaction)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  deleteMessageForMe(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSuccess: resource => resolve(new _message.DeleteMessageForMeSucceededResult(resource)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  deleteMessage(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSuccess: resource => resolve(new _message.DeleteMessageSucceededResult(resource)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
  ...
  getReadReceipts(request) {
    ...
    return new Promise(resolve => {
      ...
      }).then(paginator => resolve(new _readReceipt.GetReadReceiptsSucceededResult(paginator))).catch(error => resolve(new _result.ChatKittyFailedResult(error)));
    });
  }
  ...
  inviteUser(request) {
    ...
    if (!destination) {
      throw new _channel.ChannelNotInvitableError(request.channel);
    }
    ...
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        onSuccess: resource => {
          resolve(new _channel.InvitedUserResult(resource));
        },
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  ...
  getUser(param) {
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: user => {
          resolve(new _user.GetUserSucceededResult(user));
        }
      });
    });
  }
  ...
  getUserIsChannelMember(request) {
    ...
    return new Promise(resolve => {
      this.stompX.relayResource({
        ...
        onSuccess: resource => {
          resolve(new _user.GetUserIsChannelMemberSucceededResult(resource.exists));
        },
        onError: error => {
          resolve(new _result.ChatKittyFailedResult(error));
        }
  ...
  blockUser(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSuccess: resource => {
          resolve(new _user.BlockUserSucceededResult(resource));
        },
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  ...
  getUserBlockList() {
    ...
    return new Promise(resolve => {
      _pagination.ChatKittyPaginator.createInstance({
        ...
        contentName: 'items'
      }).then(paginator => resolve(new _userBlockListItem.GetUserBlockListSucceededResult(paginator))).catch(error => resolve(new _result.ChatKittyFailedResult(error)));
    });
  }
  ...
  deleteUserBlockListItem(request) {
    return new Promise(resolve => {
      this.stompX.sendAction({
        ...
        body: {},
        onSuccess: resource => resolve(new _userBlockListItem.DeleteUserBlockListItemSucceededResult(resource)),
        onError: error => resolve(new _result.ChatKittyFailedResult(error))
      });
    });
  }
...
class MessageMapper {
  ...
  map(message) {
    if ((0, _message.isFileMessage)(message)) {
      return { ...message,
        file: { ...message.file,
...
class P2PConnection {
  constructor(peer, stream, signalDispatcher, onParticipantActive) {
    ...
    this.rtcPeerConnection = new _reactNativeWebrtc.RTCPeerConnection(P2PConnection.rtcConfiguration);
