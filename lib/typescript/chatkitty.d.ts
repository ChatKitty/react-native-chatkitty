...
import { AcceptCallRequest, AcceptCallResult, Call, GetCallResult, GetCallsRequest, GetCallsResult, DeclineCallRequest, DeclineCallResult, StartCallRequest, StartCallResult } from './call';
...
import { GetUserMediaSettingsRequest, GetUserMediaSettingsResult, UserMediaSettings } from './user-media-settings';
...
interface Calls {
    ...
    getUserMediaSettings(request: GetUserMediaSettingsRequest): Promise<GetUserMediaSettingsResult>;
    onCallInvite(onNextOrObserver: ChatKittyObserver<Call> | ((call: Call) => void)): ChatKittyUnsubscribe;
    onCallActive(onNextOrObserver: ChatKittyObserver<Call> | ((call: Call) => void)): ChatKittyUnsubscribe;
    onParticipantAcceptedCall(onNextOrObserver: ChatKittyObserver<User> | ((user: User) => void)): ChatKittyUnsubscribe;
    onParticipantDeclinedCall(onNextOrObserver: ChatKittyObserver<User> | ((user: User) => void)): ChatKittyUnsubscribe;
    onParticipantActive(onNextOrObserver: ChatKittyObserver<{
        user: User;
        stream: MediaStream;
    }> | ((user: User, stream: MediaStream) => void)): ChatKittyUnsubscribe;
    onParticipantMediaSettingsUpdated(onNextOrObserver: ChatKittyObserver<UserMediaSettings> | ((settings: UserMediaSettings) => void)): ChatKittyUnsubscribe;
    onParticipantLeftCall(onNextOrObserver: ChatKittyObserver<User> | ((user: User) => void)): ChatKittyUnsubscribe;
    onCallEnded(onNextOrObserver: ChatKittyObserver<Call> | ((call: Call) => void)): ChatKittyUnsubscribe;
    close(): void;
}
